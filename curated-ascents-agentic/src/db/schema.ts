...
// ============================================
// BLOG & CONTENT MARKETING TABLES
// ============================================

// Blog post status enum
export const blogPostStatusEnum = pgEnum('blog_post_status', [
  'draft',      // Work in progress
  'scheduled',  // Ready to publish at scheduledAt
  'published',  // Live on the site
  'archived'    // No longer visible
]);

// Blog content type enum
export const blogContentTypeEnum = pgEnum('blog_content_type', [
  'destination_guide',  // Comprehensive travel guides
  'travel_tips',        // Practical advice
  'packing_list',       // What to bring
  'cultural_insights',  // Local customs, festivals
  'seasonal_content',   // Best times to visit
  'trip_report'         // Client stories
]);
...
// Blog categories - organize blog posts by topic
...
export const blogPosts = pgTable('blog_posts', {
  ...
  gallery: jsonb('gallery'), // Array of { url, alt, caption }
  ...
  // Publication
  status: text('status').default('draft').notNull(), // matches blogPostStatusEnum
  authorName: text('author_name').default('CuratedAscents Team'),
  publishedAt: timestamp('published_at'),
  scheduledAt: timestamp('scheduled_at'),

  // Content metadata
  contentType: text('content_type').default('destination_guide'), // matches blogContentTypeEnum
...
// Blog social posts - social media distribution
export const blogSocialPosts = pgTable('blog_social_posts', {
  id: serial('id').primaryKey(),
  blogPostId: integer('blog_post_id').references(() => blogPosts.id).notNull(),

  // Platform details
  platform: text('platform').notNull(), // matches socialPlatformEnum
  postText: text('post_text').notNull(),
  hashtags: jsonb('hashtags'), // Array of strings
  imageUrl: text('image_url'),

  // Scheduling
  status: text('status').default('draft').notNull(), // matches socialPostStatusEnum
  scheduledAt: timestamp('scheduled_at'),
  publishedAt: timestamp('published_at'),

  // Analytics (updated via webhooks or manual)
