...
export const itineraries: Itinerary[] = [
  {
    ...
    days: [
      { day: 1, title: "Arrival in Kathmandu", description: "Private airport transfer. Afternoon orientation walk through Thamel and welcome dinner at the hotel's rooftop restaurant with panoramic mountain views.", accommodation: "Dwarika's Hotel, Kathmandu", meals: "Dinner" },
      ...
      { day: 4, title: "Fly to Chitwan", description: "Morning mountain sunrise. Scenic flight to Bharatpur, then private transfer to your luxury jungle lodge inside Chitwan National Park.", accommodation: "Meghauli Serai (Taj), Chitwan", meals: "Breakfast, Lunch, Dinner" },
  ...
  },
  {
    ...
    days: [
      ...
      { day: 2, title: "Tiger's Nest Hike", description: "The iconic hike to Taktsang Monastery (2,950m), perched on a sheer cliff 900m above the valley floor. Stop at the hillside cafeteria for tea with valley views.", accommodation: "Amankora Paro", meals: "Breakfast, Lunch, Dinner", altitude: "2,950m" },
  ...
  },
  {
    ...
    days: [
      ...
      { day: 3, title: "Delhi to Rishikesh", description: "Drive to Rishikesh along the Ganges. Check in to riverside retreat. Evening Ganga Aarti ceremony at Triveni Ghat — a mesmerizing fire ritual.", accommodation: "Ananda in the Himalayas", meals: "Breakfast, Dinner" },
      ...
      { day: 7, title: "Fly to Ladakh", description: "Drive to Dehradun and fly to Leh. Rest and acclimatize at altitude (3,500m). Gentle evening walk through Leh's old town.", accommodation: "The Grand Dragon, Leh", meals: "Breakfast, Dinner", altitude: "3,500m" },
      ...
      { day: 10, title: "Nubra to Pangong Lake", description: "Cross Shyok and Chang La to reach Pangong Tso — a breathtaking turquoise lake stretching into Tibet. Watch the colors shift at sunset.", accommodation: "Pangong Retreat Camp", meals: "Breakfast, Lunch, Dinner", altitude: "4,350m" },
  ...
  },
  {
    ...
    days: [
      ...
      { day: 5, title: "Gyantse to Shigatse", description: "Morning visit to Gyantse Kumbum — Tibet's largest and most spectacular stupa with its nine tiers of chapels. Drive to Shigatse and explore Tashilhunpo Monastery.", accommodation: "Shigatse Hotel", meals: "Breakfast, Lunch, Dinner", altitude: "3,840m" },
