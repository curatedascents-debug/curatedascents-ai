...
interface TripBriefing7DayEmailProps {
  clientName?: string;
...
export default function TripBriefing7DayEmail({
  clientName,
  bookingReference,
  tripName,
  destination,
    ...
    <Html>
      ...
      <Body style={body}>
        <Container style={container}>
          ...
          <Text style={heading}>Your Adventure Awaits!</Text>

          <Text style={paragraph}>
            Dear {clientName || "Traveler"},
          </Text>
          <Text style={paragraph}>
            Your trip is just <strong>one week away</strong>! We are excited to share your trip briefing
            with all the details you need to prepare for your upcoming adventure.
          </Text>
          ...
          {services.length > 0 && (
            <>
              <Text style={sectionHeading}>Confirmed Services</Text>
          ...
          <Text style={sectionHeading}>Pre-Departure Checklist</Text>
          <Section style={checklistBox}>
            <Text style={checklistItem}>✓ Confirm your passport validity (6+ months from travel date)</Text>
            <Text style={checklistItem}>✓ Check visa requirements for {destination || "your destination"}</Text>
            <Text style={checklistItem}>✓ Review your travel insurance coverage</Text>
            <Text style={checklistItem}>✓ Pack appropriate clothing for the climate and activities</Text>
            <Text style={checklistItem}>✓ Inform your bank of travel plans to avoid card blocks</Text>
            <Text style={checklistItem}>✓ Download offline maps and essential apps</Text>
            <Text style={checklistItem}>✓ Prepare copies of important documents</Text>
          </Section>

          <Text style={paragraph}>
            <strong>Questions?</strong> Our team is here to help. Simply reply to this email
            or contact us anytime before your departure.
          </Text>
